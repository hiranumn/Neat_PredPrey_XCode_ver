...
namespace NEAT {
	...
	//Added for Predator/Prey experiment
	extern int num_generations; //external control for number of generations
	extern int random_seed; //external control over random seed (so runs can be recreated)
	extern string filedist;
