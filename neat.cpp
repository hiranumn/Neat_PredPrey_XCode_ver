...
int NEAT::num_generations = 0;
int NEAT::random_seed = 0;
string NEAT::filedist = "";
...
bool NEAT::load_neat_params(const char *filename, bool output) {
    ...
    paramFile>>curword;
	paramFile>>NEAT::num_generations;
	
    paramFile>>curword;
	paramFile>>NEAT::random_seed;
	
	paramFile>>curword;
	paramFile>>NEAT::filedist;

    paramFile>>curword;
    paramFile>>NEAT::tournament_size;
